            ...
            <div className="container-main">
              ...
              <div className="container-item">
                <form>
                  ...
                  <div className="div-li">
                    <label className={"label-r"}>
                      Barcode <span style={{ color: "tomato" }}>*</span>
                      <input
                        className={"input-r"}
                        type="text"
                  ...
                  this.state.voterID.length === 6 &&
                  !this.state.currentVoter.isRegistered &&  
                  !this.state.currentVoter.isVerified ? null : (
                    <p style={{color: "red"}}>
                      <p> {this.state.voterPhone.length !== 11 ? "Please enter a valid phone number." : ""}</p>
                      <p>{this.state.voterAge < 18 ? "You must be at least 18 years old to register." : ""}</p>
                      <p>{this.state.voterID.length !== 6 ? "Please enter your barcode from university." : ""}</p>
                      <p>{this.state.currentVoter.isRegistered ? "You are already registered." : ""}</p>
                      <p>{this.state.currentVoter.isVerified ? "You are already verified." : ""}</p>
                    </p>
                    )}
                </form>
              </div>
